(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function s(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(r){if(r.ep)return;r.ep=!0;const a=s(r);fetch(r.href,a)}})();const Ye="modulepreload",et=function(t){return"/table-saw-project/"+t},fe={},tt=function(e,s,n){let r=Promise.resolve();if(s&&s.length>0){let u=function(p){return Promise.all(p.map(h=>Promise.resolve(h).then(d=>({status:"fulfilled",value:d}),d=>({status:"rejected",reason:d}))))};var i=u;document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),o=c?.nonce||c?.getAttribute("nonce");r=u(s.map(p=>{if(p=et(p),p in fe)return;fe[p]=!0;const h=p.endsWith(".css"),d=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${d}`))return;const k=document.createElement("link");if(k.rel=h?"stylesheet":Ye,h||(k.as="script"),k.crossOrigin="",k.href=p,o&&k.setAttribute("nonce",o),document.head.appendChild(k),h)return new Promise((m,v)=>{k.addEventListener("load",m),k.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${p}`)))})}))}function a(c){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=c,window.dispatchEvent(o),!o.defaultPrevented)throw c}return r.then(c=>{for(const o of c||[])o.status==="rejected"&&a(o.reason);return e().catch(a)})};function ee(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var T=ee();function _e(t){T=t}var P={exec:()=>null};function g(t,e=""){let s=typeof t=="string"?t:t.source,n={replace:(r,a)=>{let i=typeof a=="string"?a:a.source;return i=i.replace(x.caret,"$1"),s=s.replace(r,i),n},getRegex:()=>new RegExp(s,e)};return n}var rt=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),x={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}#`),htmlBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}<(?:[a-z].*>|!--)`,"i")},st=/^(?:[ \t]*(?:\n|$))+/,nt=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,at=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,z=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,it=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,te=/(?:[*+-]|\d{1,9}[.)])/,Re=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Te=g(Re).replace(/bull/g,te).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),lt=g(Re).replace(/bull/g,te).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),re=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,ot=/^[^\n]+/,se=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,ct=g(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",se).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),pt=g(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,te).getRegex(),F="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",ne=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ut=g("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",ne).replace("tag",F).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Ie=g(re).replace("hr",z).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",F).getRegex(),dt=g(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Ie).getRegex(),ae={blockquote:dt,code:nt,def:ct,fences:at,heading:it,hr:z,html:ut,lheading:Te,list:pt,newline:st,paragraph:Ie,table:P,text:ot},ke=g("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",z).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",F).getRegex(),ht={...ae,lheading:lt,table:ke,paragraph:g(re).replace("hr",z).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",ke).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",F).getRegex()},gt={...ae,html:g(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",ne).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:P,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:g(re).replace("hr",z).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Te).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},ft=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,kt=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Ae=/^( {2,}|\\)\n(?!\s*$)/,mt=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,H=/[\p{P}\p{S}]/u,ie=/[\s\p{P}\p{S}]/u,Le=/[^\s\p{P}\p{S}]/u,bt=g(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,ie).getRegex(),Ee=/(?!~)[\p{P}\p{S}]/u,wt=/(?!~)[\s\p{P}\p{S}]/u,xt=/(?:[^\s\p{P}\p{S}]|~)/u,vt=g(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",rt?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Pe=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,yt=g(Pe,"u").replace(/punct/g,H).getRegex(),$t=g(Pe,"u").replace(/punct/g,Ee).getRegex(),ze="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",St=g(ze,"gu").replace(/notPunctSpace/g,Le).replace(/punctSpace/g,ie).replace(/punct/g,H).getRegex(),_t=g(ze,"gu").replace(/notPunctSpace/g,xt).replace(/punctSpace/g,wt).replace(/punct/g,Ee).getRegex(),Rt=g("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Le).replace(/punctSpace/g,ie).replace(/punct/g,H).getRegex(),Tt=g(/\\(punct)/,"gu").replace(/punct/g,H).getRegex(),It=g(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),At=g(ne).replace("(?:-->|$)","-->").getRegex(),Lt=g("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",At).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),j=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Et=g(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",j).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Ce=g(/^!?\[(label)\]\[(ref)\]/).replace("label",j).replace("ref",se).getRegex(),Me=g(/^!?\[(ref)\](?:\[\])?/).replace("ref",se).getRegex(),Pt=g("reflink|nolink(?!\\()","g").replace("reflink",Ce).replace("nolink",Me).getRegex(),me=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,le={_backpedal:P,anyPunctuation:Tt,autolink:It,blockSkip:vt,br:Ae,code:kt,del:P,emStrongLDelim:yt,emStrongRDelimAst:St,emStrongRDelimUnd:Rt,escape:ft,link:Et,nolink:Me,punctuation:bt,reflink:Ce,reflinkSearch:Pt,tag:Lt,text:mt,url:P},zt={...le,link:g(/^!?\[(label)\]\((.*?)\)/).replace("label",j).getRegex(),reflink:g(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",j).getRegex()},W={...le,emStrongRDelimAst:_t,emStrongLDelim:$t,url:g(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",me).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:g(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",me).getRegex()},Ct={...W,br:g(Ae).replace("{2,}","*").getRegex(),text:g(W.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},M={normal:ae,gfm:ht,pedantic:gt},A={normal:le,gfm:W,breaks:Ct,pedantic:zt},Mt={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},be=t=>Mt[t];function S(t,e){if(e){if(x.escapeTest.test(t))return t.replace(x.escapeReplace,be)}else if(x.escapeTestNoEncode.test(t))return t.replace(x.escapeReplaceNoEncode,be);return t}function we(t){try{t=encodeURI(t).replace(x.percentDecode,"%")}catch{return null}return t}function xe(t,e){let s=t.replace(x.findPipe,(a,i,c)=>{let o=!1,u=i;for(;--u>=0&&c[u]==="\\";)o=!o;return o?"|":" |"}),n=s.split(x.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),e)if(n.length>e)n.splice(e);else for(;n.length<e;)n.push("");for(;r<n.length;r++)n[r]=n[r].trim().replace(x.slashPipe,"|");return n}function L(t,e,s){let n=t.length;if(n===0)return"";let r=0;for(;r<n&&t.charAt(n-r-1)===e;)r++;return t.slice(0,n-r)}function qt(t,e){if(t.indexOf(e[1])===-1)return-1;let s=0;for(let n=0;n<t.length;n++)if(t[n]==="\\")n++;else if(t[n]===e[0])s++;else if(t[n]===e[1]&&(s--,s<0))return n;return s>0?-2:-1}function ve(t,e,s,n,r){let a=e.href,i=e.title||null,c=t[1].replace(r.other.outputLinkReplace,"$1");n.state.inLink=!0;let o={type:t[0].charAt(0)==="!"?"image":"link",raw:s,href:a,title:i,text:c,tokens:n.inlineTokens(c)};return n.state.inLink=!1,o}function Bt(t,e,s){let n=t.match(s.other.indentCodeCompensation);if(n===null)return e;let r=n[1];return e.split(`
...
`)}}}fences(t){let e=this.rules.block.fences.exec(t);if(e){let s=e[0],n=Bt(s,e[3]||"",this.rules);return{type:"code",raw:s,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:n}}}heading(t){let e=this.rules.block.heading.exec(t);if(e){let s=e[2].trim();if(this.rules.other.endingHash.test(s)){let n=L(s,"#");(this.options.pedantic||!n||this.rules.other.endingSpaceChar.test(n))&&(s=n.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:s,tokens:this.lexer.inline(s)}}}hr(t){let e=this.rules.block.hr.exec(t);if(e)return{type:"hr",raw:L(e[0],`
...
`,1)[0].replace(this.rules.other.listReplaceTabs,Q=>" ".repeat(3*Q.length)),d=t.split(`
...
Please report this to https://github.com/markedjs/marked.`,t){let n="<p>An error occurred:</p><pre>"+S(s.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(s);throw s}}},R=new jt;function f(t,e){return R.parse(t,e)}f.options=f.setOptions=function(t){return R.setOptions(t),f.defaults=R.defaults,_e(f.defaults),f};f.getDefaults=ee;f.defaults=T;f.use=function(...t){return R.use(...t),f.defaults=R.defaults,_e(f.defaults),f};f.walkTokens=function(t,e){return R.walkTokens(t,e)};f.parseInline=R.parseInline;f.Parser=$;f.parser=$.parse;f.Renderer=D;f.TextRenderer=oe;f.Lexer=y;f.lexer=y.lex;f.Tokenizer=N;f.Hooks=E;f.parse=f;f.options;f.setOptions;f.use;f.walkTokens;f.parseInline;$.parse;y.lex;const b=document.querySelector("#app"),qe="fixed-top-bench-atlas-progress-v1",Nt=new Set(["build","atlas","library"]);let q=null;const l={data:null,model:null,currentStepId:null,currentMediaId:null,currentResourceId:null,resourceQuery:"",resourceCategory:"all",viewer:null,progress:null,viewMode:"build",shareStatus:"",shareStatusTimer:null,viewerLoadToken:0};function X(t){return{docs:"Docs",models:"Model",plans:"Plans",drawings:"Drawings",renders:"Renders",data:"Data"}[t]||t}function _(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;")}function C(){return l.data.steps.find(t=>t.id===l.currentStepId)||l.data.steps[0]}function Dt(){return l.data.resources.find(t=>t.id===l.currentResourceId)||l.data.resources[0]}function Be(t=C()){return t.media.find(e=>e===l.currentMediaId)||t.media[0]||null}function Ot(t=C()){const e=Be(t);return e?He(e):null}function je(t){return l.data.steps.findIndex(e=>e.id===t)}function J(){const t=je(l.currentStepId);return t>0?l.data.steps[t-1].id:null}function Y(){const t=je(l.currentStepId);return t>=0&&t<l.data.steps.length-1?l.data.steps[t+1].id:null}function U(){return{completedSteps:{},actions:{},holdPoints:{},notes:{}}}function Ne(){try{const t=window.localStorage.getItem(qe);return t?{...U(),...JSON.parse(t)}:U()}catch{return U()}}function B(){window.localStorage.setItem(qe,JSON.stringify(l.progress))}function De(t,e){return`${t}:action:${e}`}function Oe(t,e){return`${t}:hold:${e}`}function Ze(t,e){return!!l.progress.actions[De(t,e)]}function Fe(t,e){return!!l.progress.holdPoints[Oe(t,e)]}function Zt(t){return t.actions.filter((e,s)=>Ze(t.id,s)).length}function Ft(t){return t.hold_points.filter((e,s)=>Fe(t.id,s)).length}function O(t){return!!l.progress.completedSteps[t]}function Ht(t){return l.data.resources.find(e=>e.id===t)}function Qt(t){return l.data.gates.find(e=>e.id===t)}function He(t){return l.data.media.find(e=>e.id===t)}function Gt(){const t=l.resourceQuery.trim().toLowerCase();return l.data.resources.filter(e=>l.resourceCategory!=="all"&&e.category!==l.resourceCategory?!1:t?[e.title,e.path,e.summary||"",e.category].join(" ").toLowerCase().includes(t):!0)}function Qe(t){return f.parse(t,{mangle:!1,headerIds:!1})}function Ut(t){return f.parseInline(t,{mangle:!1,headerIds:!1})}function Wt(t){const e=t.columns||[],s=t.preview_rows||[];return`
  ...
  `}function Vt(t){return`<pre class="code-block">${_(t.body||"")}</pre>`}function Kt(t){return`
    <figure class="image-viewer">
      <img src="${t.media_path}" alt="${t.title}" />
      <figcaption>${t.title}</figcaption>
    </figure>
  `}function Xt(t){return t?t.type==="markdown"?`<div class="markdown-body">${Qe(t.body)}</div>`:t.type==="csv"?Wt(t):t.type==="json"?Vt(t):t.type==="image"?Kt(t):'<div class="empty-state">No renderer for this resource type.</div>':'<div class="empty-state">Pick a file to inspect the underlying source.</div>'}function Ge(t){return t.resources.map(Ht).filter(Boolean)}function Jt(t){return t.gate_ids.map(Qt).filter(Boolean)}function ce(t){return Nt.has(t)?t:"build"}function ye(){const t=new URLSearchParams(window.location.search),e=t.get("step"),s=t.get("media"),n=t.get("resource"),r=t.get("mode");e&&l.data.steps.some(a=>a.id===e)&&(l.currentStepId=e),s&&(l.currentMediaId=s),n&&l.data.resources.some(a=>a.id===n)&&(l.currentResourceId=n),r&&(l.viewMode=ce(r))}function Yt(){const t=new URL(window.location.href);t.searchParams.set("step",l.currentStepId),t.searchParams.set("mode",l.viewMode),l.currentMediaId?t.searchParams.set("media",l.currentMediaId):t.searchParams.delete("media"),l.currentResourceId?t.searchParams.set("resource",l.currentResourceId):t.searchParams.delete("resource");const e=`${t.pathname}?${t.searchParams.toString()}`;window.history.replaceState({},"",e)}function er(){l.progress||(l.progress=Ne()),(!l.currentStepId||!l.data.steps.some(e=>e.id===l.currentStepId))&&(l.currentStepId=l.data.landing_step),l.viewMode=ce(l.viewMode);const t=C();(!l.currentMediaId||!t.media.includes(l.currentMediaId))&&(l.currentMediaId=t.media[0]||null),(!l.currentResourceId||!l.data.resources.some(e=>e.id===l.currentResourceId))&&(l.currentResourceId=t.resources[0]||l.data.landing_resource)}function Ue(t){l.shareStatus=t,l.shareStatusTimer&&window.clearTimeout(l.shareStatusTimer),l.shareStatusTimer=window.setTimeout(()=>{l.shareStatus="",w()},2200)}function tr(){return q||(q=tt(()=>import("./model-viewer-BijRJh67.js"),[]).catch(t=>{throw q=null,t})),q}function Z(t){if(!t||!l.data.steps.some(s=>s.id===t))return;l.currentStepId=t;const e=C();l.currentMediaId=e.media[0]||null,l.currentResourceId=e.resources[0]||l.currentResourceId,w()}function rr(t){l.viewMode=ce(t),w()}async function sr(){const t=window.location.href;try{await navigator.clipboard.writeText(t),Ue("Link copied"),w()}catch{window.prompt("Copy this link",t)}}async function nr(){try{document.fullscreenElement?await document.exitFullscreen():await document.documentElement.requestFullscreen()}catch{Ue("Fullscreen unavailable")}}function We(){const t=()=>{window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>window.print())})};if(l.viewMode!=="build"){l.viewMode="build",w(),t();return}t()}function ar(t){return O(t.id)?{label:"Done",className:"is-done"}:t.gate_ids.length||t.gate_summary.some(e=>e.gate!=="cut_now")?{label:"Watch gates",className:"is-gated"}:{label:"Ready",className:"is-ready"}}function $e(t){return String(t||"").replaceAll("_"," ").replace(/\b\w/g,e=>e.toUpperCase())}function Ve(t){return l.data.steps.length?Math.round(t/l.data.steps.length*100):0}function ir(){const t=l.data?.dashboard?.project_snapshot?.[0];if(t)return t.replace(/\s+fixed-top bench$/i,"");const e=l.model?.metadata?.overall_bounds?.max,s=l.model?.metadata?.units||"in";return!e||e.length<3?"":`${e[0]} × ${e[1]} × ${e[2]} ${s}`}function lr(){const t=new Set;return l.data.steps.forEach(e=>{e.part_cards.forEach(s=>t.add(s.part_id))}),t.size}function or(){const t=l.data.dashboard||{};return[...t.stats||[],...t.data_cards||[]]}function cr(t,e=""){return`
  ...
  `}function pr(t,e,s,n){const r=document.fullscreenElement?"Exit fullscreen":"Fullscreen",a=Ve(n);return`
    <div class="command-deck">
      <div class="command-deck__actions">
        ...
        <button class="nav-chip ${O(t.id)?"is-active":""}" data-toggle-step-done="${t.id}">
          ${O(t.id)?"Marked done":"Mark step done"}
        </button>
      </div>
      ...
      <div class="command-deck__progress">
        ...
        <div class="command-deck__metrics">
          ...
          <div class="metric-pill">
            <strong>${Zt(t)}/${t.actions.length}</strong>
            <span>actions</span>
          </div>
          <div class="metric-pill">
            <strong>${Ft(t)}/${t.hold_points.length}</strong>
  ...
  `}function Se(t,e){const s=e==="hold"?t.hold_points:t.actions,n=e==="hold"?Fe:Ze,r=e==="hold"?"data-hold-check":"data-action-check",a=e==="hold"?"No hold points captured for this step.":"No action checklist items were parsed for this step.";return s.length?`
    <div class="task-list">
      ${s.map((i,c)=>`
            <label class="task-row ${n(t.id,c)?"is-checked":""}">
              ...
              <span class="task-row__body">${e==="hold"?_(i):Ut(i)}</span>
            </label>
          `).join("")}
    </div>
  `:`<div class="empty-state empty-state--compact">${a}</div>`}function ur(t,e=""){return t.part_cards.length?`
  ...
  `:'<div class="empty-state empty-state--compact">No cut-list parts were linked to this step.</div>'}function Ke(t,e,s=!1){return`
    <aside class="reference-board ${s?"reference-board--compact":""}">
      ...
      <div class="reference-board__frame">
        ${e?`<img class="reference-board__image" src="${e.path}" alt="${e.title}" />`:'<div class="empty-stage">No media plate linked to this stage.</div>'}
      </div>
      <div class="media-strip" data-print-hide="true">
        ${t.media.map(n=>{const r=He(n);return r?`
              <button class="media-chip ${n===Be(t)?"is-active":""}" data-media-id="${n}">
                ${r.title}
              </button>
            `:""}).join("")}
      </div>
    </aside>
  `}function Xe(t){return t.length?t.map(e=>`
        <div class="gate-card">
          <strong>${e.title}</strong>
          <div class="markdown-body gate-card__body">${Qe(e.body)}</div>
          <div class="chip-row">
            ${e.parts.map(s=>`<span class="chip chip--warn">${s}</span>`).join("")}
          </div>
        </div>
      `).join(""):'<div class="empty-state empty-state--compact">This stage has no additional gate board linked beyond the general packet.</div>'}function pe(t){return t.length?`
    <div class="packet-resource-list">
      ${t.map(e=>`
            <button class="resource-card resource-card--packet" data-open-resource-library="${e.id}">
              <span class="resource-meta">${X(e.category)} · ${e.extension}</span>
              <strong>${e.title}</strong>
  ...
  `:'<div class="empty-state empty-state--compact">No step-specific references linked here yet.</div>'}function dr(t){return`
    <div class="stage-rail" data-print-hide="true">
      ${l.data.steps.map(e=>{const s=ar(e);return`
  ...
  `}function kr(t,e,s,n){const r=l.data.dashboard||{},a=ir();return`
      ...
      <div class="masthead__grid">
        <div class="masthead__copy">
          ...
          <div class="chip-row chip-row--hero">
            ...
            <span class="chip">${lr()} tracked parts</span>
        ...
        <div class="masthead__side">
          ...
          <article class="info-card">
            <div class="panel-title-row">
              ...
              <span class="panel-kicker">${Ve(n)}% complete</span>
            </div>
            ${cr(or())}
          </article>
  ...
  `}function mr({step:t,media:e,stepResourceCards:s,stepGateCards:n}){const r=t.gate_summary.some(a=>a.gate!=="cut_now");return`
  ...
  `}function br({step:t,media:e,stepResourceCards:s,stepGateCards:n}){const r=l.model?.metadata||{};return`
          ...
          <article class="panel atlas-support__callouts">
            ...
            <div class="atlas-meta-grid">
              <article class="atlas-note">
                ...
                <strong>${$e(r.precision_ready_policy||"manual fit")}</strong>
              </article>
              <article class="atlas-note">
                <span>Dust status</span>
                <strong>${$e(r.dust_mockup_status||"pending")}</strong>
              </article>
              <article class="atlas-note">
  ...
  `}function wr({step:t,resource:e}){const s=Gt(),n=Ge(t);return`
          ...
          <div class="resource-list library-resource-list">
            ${s.map(r=>`
                  <button class="resource-list-item ${r.id===e.id?"is-active":""}" data-resource-id="${r.id}">
                    <span class="resource-meta">${X(r.category)} · ${r.extension}</span>
  ...
  `}function w(){er(),Yt();const t=C(),e=J(),s=Y(),n=Dt(),r=Ot(t),a=Ge(t),i=Jt(t),c=l.data.steps.filter(u=>O(u.id)).length,o=l.viewMode==="build"?mr({step:t,media:r,stepResourceCards:a,stepGateCards:i}):l.viewMode==="atlas"?br({step:t,media:r,stepResourceCards:a,stepGateCards:i}):wr({step:t,resource:n});b.innerHTML=`
    <div class="app-shell">
      ${kr(t,e,s,c)}
      ${gr(t)}
      ${o}
    </div>
  `,xr(),l.viewMode==="atlas"?vr(t):l.viewer&&(l.viewer.destroy(),l.viewer=null)}function xr(){b.querySelectorAll("[data-step-id]").forEach(a=>{a.addEventListener("click",()=>{Z(a.dataset.stepId)})}),b.querySelectorAll("[data-jump-step]").forEach(a=>{a.disabled||a.addEventListener("click",()=>{Z(a.dataset.jumpStep)})}),b.querySelectorAll("[data-toggle-step-done]").forEach(a=>{a.addEventListener("click",()=>{const i=a.dataset.toggleStepDone;l.progress.completedSteps[i]=!l.progress.completedSteps[i],B(),w()})}),b.querySelectorAll("[data-set-mode]").forEach(a=>{a.addEventListener("click",()=>{rr(a.dataset.setMode)})}),b.querySelectorAll("[data-media-id]").forEach(a=>{a.addEventListener("click",()=>{l.currentMediaId=a.dataset.mediaId,w()})}),b.querySelectorAll("[data-resource-id]").forEach(a=>{a.addEventListener("click",()=>{l.currentResourceId=a.dataset.resourceId,w()})}),b.querySelectorAll("[data-open-resource-library]").forEach(a=>{a.addEventListener("click",()=>{l.currentResourceId=a.dataset.openResourceLibrary,l.viewMode="library",w()})}),b.querySelectorAll("[data-filter]").forEach(a=>{a.addEventListener("click",()=>{l.resourceCategory=a.dataset.filter,w()})});const t=b.querySelector("input[type='search']");t&&t.addEventListener("input",a=>{l.resourceQuery=a.currentTarget.value,w()}),b.querySelectorAll("[data-action-check]").forEach(a=>{a.addEventListener("change",()=>{l.progress.actions[De(l.currentStepId,Number(a.dataset.actionCheck))]=a.checked,B(),w()})}),b.querySelectorAll("[data-hold-check]").forEach(a=>{a.addEventListener("change",()=>{l.progress.holdPoints[Oe(l.currentStepId,Number(a.dataset.holdCheck))]=a.checked,B(),w()})});const e=b.querySelector("[data-step-notes]");e&&e.addEventListener("input",a=>{l.progress.notes[l.currentStepId]=a.currentTarget.value,B()});const s=b.querySelector("[data-copy-link]");s&&s.addEventListener("click",()=>{sr()});const n=b.querySelector("[data-print-packet]");n&&n.addEventListener("click",()=>{We()});const r=b.querySelector("[data-toggle-fullscreen]");r&&r.addEventListener("click",()=>{nr()})}async function vr(t){const e=b.querySelector("#modelViewerMount");if(!e||!l.model)return;l.viewer&&(l.viewer.destroy(),l.viewer=null);const s=++l.viewerLoadToken;e.innerHTML=fr(t);try{const{createModelViewer:n}=await tr();if(s!==l.viewerLoadToken||!e.isConnected)return;l.viewer=n(e,l.model,{...t.viewer,summary:t.focus})}catch(n){if(s!==l.viewerLoadToken||!e.isConnected)return;l.viewer=null,e.innerHTML=`
    ...
    `,console.error(n)}}async function yr(){const[t,e]=await Promise.all([fetch("/generated/instructions-data.json"),fetch("/generated/bench-model.json")]);if(!t.ok)throw new Error(`Failed to load generated site data: ${t.status}`);if(!e.ok)throw new Error(`Failed to load generated 3D model: ${e.status}`);l.data=await t.json(),l.model=await e.json(),l.progress=Ne(),ye(),window.addEventListener("keydown",s=>{s.target&&["INPUT","TEXTAREA"].includes(s.target.tagName)||(s.key==="ArrowRight"&&Y()&&Z(Y()),s.key==="ArrowLeft"&&J()&&Z(J()),s.key.toLowerCase()==="p"&&(s.metaKey||s.ctrlKey)&&(s.preventDefault(),We()))}),window.addEventListener("fullscreenchange",()=>w()),window.addEventListener("popstate",()=>{ye(),w()}),w()}yr().catch(t=>{b.innerHTML=`
    <div class="fatal">
